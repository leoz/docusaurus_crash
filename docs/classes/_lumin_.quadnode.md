---
id: "_lumin_.quadnode"
title: "lumin.QuadNode"
sidebar_label: "lumin.QuadNode"
---

[magic-script-typings](../index.md) › [&quot;lumin&quot;](../modules/_lumin_.md) › [QuadNode](_lumin_.quadnode.md)
...
* [addChild](_lumin_.quadnode.md#addchild)
* [addMoveCallback](_lumin_.quadnode.md#addmovecallback)
* [addToLayer](_lumin_.quadnode.md#addtolayer)
* [delayMove](_lumin_.quadnode.md#delaymove)
* [enableVisualState](_lumin_.quadnode.md#enablevisualstate)
* [findChild](_lumin_.quadnode.md#findchild)
* [findChildren](_lumin_.quadnode.md#findchildren)
* [findParent](_lumin_.quadnode.md#findparent)
* [getAABB](_lumin_.quadnode.md#getaabb)
* [getAnchorPosition](_lumin_.quadnode.md#getanchorposition)
* [getChild](_lumin_.quadnode.md#getchild)
* [getChildCount](_lumin_.quadnode.md#getchildcount)
* [getColor](_lumin_.quadnode.md#getcolor)
* [getCurrentPrismTransform](_lumin_.quadnode.md#getcurrentprismtransform)
* [getCurrentWorldTransform](_lumin_.quadnode.md#getcurrentworldtransform)
* [getCursorHoverState](_lumin_.quadnode.md#getcursorhoverstate)
* [getLocalAABB](_lumin_.quadnode.md#getlocalaabb)
* [getLocalPosition](_lumin_.quadnode.md#getlocalposition)
* [getLocalRotation](_lumin_.quadnode.md#getlocalrotation)
* [getLocalScale](_lumin_.quadnode.md#getlocalscale)
* [getLocalTransform](_lumin_.quadnode.md#getlocaltransform)
* [getName](_lumin_.quadnode.md#getname)
* [getNodeId](_lumin_.quadnode.md#getnodeid)
* [getParent](_lumin_.quadnode.md#getparent)
* [getParentedBoneName](_lumin_.quadnode.md#getparentedbonename)
* [getPrismId](_lumin_.quadnode.md#getprismid)
* [getPrismPosition](_lumin_.quadnode.md#getprismposition)
* [getRenderResource](_lumin_.quadnode.md#getrenderresource)
* [getRenderingLayer](_lumin_.quadnode.md#getrenderinglayer)
* [getRigidBody](_lumin_.quadnode.md#getrigidbody)
* [getRoot](_lumin_.quadnode.md#getroot)
* [getShader](_lumin_.quadnode.md#getshader)
* [getShaderType](_lumin_.quadnode.md#getshadertype)
* [getSize](_lumin_.quadnode.md#getsize)
* [getTexCoords](_lumin_.quadnode.md#gettexcoords)
* [getVertices](_lumin_.quadnode.md#getvertices)
* [getViewMode](_lumin_.quadnode.md#getviewmode)
* [getWorldPosition](_lumin_.quadnode.md#getworldposition)
* [isDrmContent](_lumin_.quadnode.md#isdrmcontent)
* [isInLayer](_lumin_.quadnode.md#isinlayer)
* [isInSubtree](_lumin_.quadnode.md#isinsubtree)
* [isSkipRaycast](_lumin_.quadnode.md#isskipraycast)
* [isTriggerable](_lumin_.quadnode.md#istriggerable)
* [isVisibilityInherited](_lumin_.quadnode.md#isvisibilityinherited)
* [isVisible](_lumin_.quadnode.md#isvisible)
* [isVisibleInPrism](_lumin_.quadnode.md#isvisibleinprism)
* [removeChild](_lumin_.quadnode.md#removechild)
* [removeFromLayer](_lumin_.quadnode.md#removefromlayer)
* [setAnchorPosition](_lumin_.quadnode.md#setanchorposition)
* [setBackFaceCulls](_lumin_.quadnode.md#setbackfaceculls)
* [setBloomStrength](_lumin_.quadnode.md#setbloomstrength)
* [setBlooms](_lumin_.quadnode.md#setblooms)
* [setCastsShadows](_lumin_.quadnode.md#setcastsshadows)
* [setColor](_lumin_.quadnode.md#setcolor)
* [setCursorHoverState](_lumin_.quadnode.md#setcursorhoverstate)
* [setDrmContent](_lumin_.quadnode.md#setdrmcontent)
* [setFrontFaceCulls](_lumin_.quadnode.md#setfrontfaceculls)
* [setIsOpaque](_lumin_.quadnode.md#setisopaque)
* [setIsUI](_lumin_.quadnode.md#setisui)
* [setLocalPosition](_lumin_.quadnode.md#setlocalposition)
* [setLocalRotation](_lumin_.quadnode.md#setlocalrotation)
* [setLocalScale](_lumin_.quadnode.md#setlocalscale)
* [setLocalTransform](_lumin_.quadnode.md#setlocaltransform)
* [setLodBias](_lumin_.quadnode.md#setlodbias)
* [setName](_lumin_.quadnode.md#setname)
* [setParentedBoneName](_lumin_.quadnode.md#setparentedbonename)
* [setPushesStencil](_lumin_.quadnode.md#setpushesstencil)
* [setReadsClip](_lumin_.quadnode.md#setreadsclip)
* [setReadsDepth](_lumin_.quadnode.md#setreadsdepth)
* [setReceivesLight](_lumin_.quadnode.md#setreceiveslight)
* [setReceivesShadows](_lumin_.quadnode.md#setreceivesshadows)
* [setRenderResource](_lumin_.quadnode.md#setrenderresource)
* [setRenderingLayer](_lumin_.quadnode.md#setrenderinglayer)
* [setShader](_lumin_.quadnode.md#setshader)
* [setSize](_lumin_.quadnode.md#setsize)
* [setSkipRaycast](_lumin_.quadnode.md#setskipraycast)
* [setSubTexture](_lumin_.quadnode.md#setsubtexture)
* [setTexCoords](_lumin_.quadnode.md#settexcoords)
* [setTriggerable](_lumin_.quadnode.md#settriggerable)
* [setViewMode](_lumin_.quadnode.md#setviewmode)
* [setVisibilityInherited](_lumin_.quadnode.md#setvisibilityinherited)
* [setVisible](_lumin_.quadnode.md#setvisible)
* [setWritesColor](_lumin_.quadnode.md#setwritescolor)
* [setWritesDepth](_lumin_.quadnode.md#setwritesdepth)
* [setWritesStencil](_lumin_.quadnode.md#setwritesstencil)
* [stopTransformAnimations](_lumin_.quadnode.md#stoptransformanimations)
* [Delete](_lumin_.quadnode.md#static-delete)
