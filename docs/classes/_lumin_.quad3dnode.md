---
id: "_lumin_.quad3dnode"
title: "lumin.Quad3dNode"
sidebar_label: "lumin.Quad3dNode"
---

[magic-script-typings](../index.md) › [&quot;lumin&quot;](../modules/_lumin_.md) › [Quad3dNode](_lumin_.quad3dnode.md)
...
* [addChild](_lumin_.quad3dnode.md#addchild)
* [addMoveCallback](_lumin_.quad3dnode.md#addmovecallback)
* [addToLayer](_lumin_.quad3dnode.md#addtolayer)
* [delayMove](_lumin_.quad3dnode.md#delaymove)
* [enableVisualState](_lumin_.quad3dnode.md#enablevisualstate)
* [findChild](_lumin_.quad3dnode.md#findchild)
* [findChildren](_lumin_.quad3dnode.md#findchildren)
* [findParent](_lumin_.quad3dnode.md#findparent)
* [getAABB](_lumin_.quad3dnode.md#getaabb)
* [getAnchorPosition](_lumin_.quad3dnode.md#getanchorposition)
* [getChild](_lumin_.quad3dnode.md#getchild)
* [getChildCount](_lumin_.quad3dnode.md#getchildcount)
* [getColor](_lumin_.quad3dnode.md#getcolor)
* [getCurrentPrismTransform](_lumin_.quad3dnode.md#getcurrentprismtransform)
* [getCurrentWorldTransform](_lumin_.quad3dnode.md#getcurrentworldtransform)
* [getCursorHoverState](_lumin_.quad3dnode.md#getcursorhoverstate)
* [getLocalAABB](_lumin_.quad3dnode.md#getlocalaabb)
* [getLocalPosition](_lumin_.quad3dnode.md#getlocalposition)
* [getLocalRotation](_lumin_.quad3dnode.md#getlocalrotation)
* [getLocalScale](_lumin_.quad3dnode.md#getlocalscale)
* [getLocalTransform](_lumin_.quad3dnode.md#getlocaltransform)
* [getName](_lumin_.quad3dnode.md#getname)
* [getNodeId](_lumin_.quad3dnode.md#getnodeid)
* [getParent](_lumin_.quad3dnode.md#getparent)
* [getParentedBoneName](_lumin_.quad3dnode.md#getparentedbonename)
* [getPrismId](_lumin_.quad3dnode.md#getprismid)
* [getPrismPosition](_lumin_.quad3dnode.md#getprismposition)
* [getRenderResource](_lumin_.quad3dnode.md#getrenderresource)
* [getRenderingLayer](_lumin_.quad3dnode.md#getrenderinglayer)
* [getRigidBody](_lumin_.quad3dnode.md#getrigidbody)
* [getRoot](_lumin_.quad3dnode.md#getroot)
* [getShader](_lumin_.quad3dnode.md#getshader)
* [getSize](_lumin_.quad3dnode.md#getsize)
* [getTexCoords](_lumin_.quad3dnode.md#gettexcoords)
* [getWorldPosition](_lumin_.quad3dnode.md#getworldposition)
* [isDrmContent](_lumin_.quad3dnode.md#isdrmcontent)
* [isInLayer](_lumin_.quad3dnode.md#isinlayer)
* [isInSubtree](_lumin_.quad3dnode.md#isinsubtree)
* [isSkipRaycast](_lumin_.quad3dnode.md#isskipraycast)
* [isTriggerable](_lumin_.quad3dnode.md#istriggerable)
* [isVisibilityInherited](_lumin_.quad3dnode.md#isvisibilityinherited)
* [isVisible](_lumin_.quad3dnode.md#isvisible)
* [isVisibleInPrism](_lumin_.quad3dnode.md#isvisibleinprism)
* [removeChild](_lumin_.quad3dnode.md#removechild)
* [removeFromLayer](_lumin_.quad3dnode.md#removefromlayer)
* [setAnchorPosition](_lumin_.quad3dnode.md#setanchorposition)
* [setBackFaceCulls](_lumin_.quad3dnode.md#setbackfaceculls)
* [setBloomStrength](_lumin_.quad3dnode.md#setbloomstrength)
* [setBlooms](_lumin_.quad3dnode.md#setblooms)
* [setCastsShadows](_lumin_.quad3dnode.md#setcastsshadows)
* [setColor](_lumin_.quad3dnode.md#setcolor)
* [setCursorHoverState](_lumin_.quad3dnode.md#setcursorhoverstate)
* [setDrmContent](_lumin_.quad3dnode.md#setdrmcontent)
* [setFrontFaceCulls](_lumin_.quad3dnode.md#setfrontfaceculls)
* [setIsOpaque](_lumin_.quad3dnode.md#setisopaque)
* [setIsUI](_lumin_.quad3dnode.md#setisui)
* [setLocalPosition](_lumin_.quad3dnode.md#setlocalposition)
* [setLocalRotation](_lumin_.quad3dnode.md#setlocalrotation)
* [setLocalScale](_lumin_.quad3dnode.md#setlocalscale)
* [setLocalTransform](_lumin_.quad3dnode.md#setlocaltransform)
* [setName](_lumin_.quad3dnode.md#setname)
* [setParentedBoneName](_lumin_.quad3dnode.md#setparentedbonename)
* [setPushesStencil](_lumin_.quad3dnode.md#setpushesstencil)
* [setReadsClip](_lumin_.quad3dnode.md#setreadsclip)
* [setReadsDepth](_lumin_.quad3dnode.md#setreadsdepth)
* [setReceivesLight](_lumin_.quad3dnode.md#setreceiveslight)
* [setReceivesShadows](_lumin_.quad3dnode.md#setreceivesshadows)
* [setRenderResource](_lumin_.quad3dnode.md#setrenderresource)
* [setRenderingLayer](_lumin_.quad3dnode.md#setrenderinglayer)
* [setShader](_lumin_.quad3dnode.md#setshader)
* [setSize](_lumin_.quad3dnode.md#setsize)
* [setSkipRaycast](_lumin_.quad3dnode.md#setskipraycast)
* [setTexCoords](_lumin_.quad3dnode.md#settexcoords)
* [setTriggerable](_lumin_.quad3dnode.md#settriggerable)
* [setVisibilityInherited](_lumin_.quad3dnode.md#setvisibilityinherited)
* [setVisible](_lumin_.quad3dnode.md#setvisible)
* [setWritesColor](_lumin_.quad3dnode.md#setwritescolor)
* [setWritesDepth](_lumin_.quad3dnode.md#setwritesdepth)
* [setWritesStencil](_lumin_.quad3dnode.md#setwritesstencil)
* [stopTransformAnimations](_lumin_.quad3dnode.md#stoptransformanimations)
* [Delete](_lumin_.quad3dnode.md#static-delete)
...
*Overrides [Node](_lumin_.node.md).[getLocalAABB](_lumin_.node.md#getlocalaabb)*
